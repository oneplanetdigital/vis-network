...
import CircleAroundCircle from "./nodes/shapes/CircleAroundCircle";
import SquareAroundSquare from "./nodes/shapes/SquareAroundSquare";
    ...
    if (currentShape === this.options.shape && this.shape) {
      ...
      switch (this.options.shape) {
        ...
        case "circleAroundCircle":
          this.shape = new CircleAroundCircle(
            this.options,
            this.body,
            this.labelModule
          );
          break;
        case "squareAroundSquare":
          this.shape = new SquareAroundSquare(
            this.options,
            this.body,
            this.labelModule
          );
